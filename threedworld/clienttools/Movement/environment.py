...
config = {
	...
	"grid_size": 0.4,    #Determines how fine tuned a grid the objects are placed on during Proc. Gen. Smaller the number, the
        "use_mongodb_inter": 1, 
        "mongodb_items": {"shape_cons": {"find_argu": shapenet_inquery, "choose_mode": "random", "choose_argu": {"number": 0, "seed": 0}}, "dosch":  {"find_argu": dosch_inquery, "choose_mode": "random", "choose_argu": {"number": 10, "seed": 0}}}
}
