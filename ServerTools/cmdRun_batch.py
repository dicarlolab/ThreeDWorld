...
if __name__ == "__main__":
    ...
    os.system('cp -r /home/chengxuz/test_empty_project ' + project_path)
    ...
    cmd_str         = '/opt/Unity/Editor/Unity -batchmode -quit -projectPath ' + project_path + ' -executeMethod CreatePrefabCMD.CreatePrefabFromModel -nographics -logFile -outputDir "Assets/Models/sel_objs/temp_for_cmdRun/"'
    print(cmd_str)
    os.system(cmd_str)
