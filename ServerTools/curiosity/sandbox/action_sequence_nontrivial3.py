...
def getEpisode(epnum):
  ...
  while timestep < EPISODE_LENGTH + 1:
    pf = str(timestep)
    info, nstr, ostr, imstr = handle_message(sock, write=True, outdir='sequences_nt3', prefix=pf)
  ...
  with tf.Session() as sess:
    ...
    for episode in xrange(NUM_EPISODES):
      ...
      _, l, lr, predictions = sess.run(
          ...
          feed_dict=feed_dict)
      print(episode, l, lr)
      np.save('sequences_nt3/prediction.npy', predictions)
