...
print("connecting...")
sock.connect("tcp://18.93.5.202:23042")
print("...connected")
    ...
    if not valid[start: end].all():
        ...
        for i in range(bsize):
            info, narray, oarray, imarray = handle_message(sock, 
                                                           write=True, 
                                                           outdir='/data2/datasource3_ims', prefix=str(i))
            msg = {'n': 4,
            ...
            if i % 5 == 0:
                ...
                a, b, c = [.2 * rng.uniform(), 0.1 * rng.uniform(), 0.2 * rng.uniform()]
            ...
            if i % 5 > 0:
                ...
                ot = obs[rng.permutation(len(obs))[::3]]
                print ('turning %d things %.2f' % (len(ot), g))
                for o in ot:
                    act = {
                           'id': str(o), 
                           'force': [0, 0, 0],
